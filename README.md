...
Проекты (скрипты), которые были разработаны для применения в работе

[**Проект 1: Отчет по подготовке планов ТОиР**](https://github.com/av-paramonov/report_on_plans)
Использован `Python` с применением библиотек `pandas`, `openpyxl`, `matplotlib`, `python-docx`, `tempfile`  
> Цель: автоматизациа отчетов по подготовке планов технического обслуживания и ремонта (ТОиР) на основе данных из Excel-файлов.  
